...
echo  "$ku╚══════════════════════════════╝"
echo "$bi╔═══════════════════════╗"
echo "$bi║$pu[$i 1 $pu].$me Tools GABUT$bi     ║"
echo "$bi║$pu[$i 2 $pu].$me Tools Bot-Depes$bi ║"
echo "$bi║$pu[$i 3 $pu].$me Tools Milos :v $bi ║"
echo "$bi║$pu[$i 4 $pu].$me Tools Spam SMS $bi ║"
echo "$bi║$pu[$i 5 $pu].$me Tools MsfHelper $bi║"
echo "$bi║$pu[$i 6 $pu].$pu Info Tools      $bi║"   
echo "$bi║$pu[$i 7 $pu].$pu Install Bahan   $bi║"
echo "$bi║$pu[$i 8 $pu].$pu Tools Terkey    $bi║"
echo "$bi║$pu[$i 9 $pu].$pu Tools OhMyZsh   $bi║"
echo "$bi║$pu[$me 0 $pu].$enda Exit            $bi║"
echo "$bi╚═══════════════════════╝"
echo ""
...
clear
toilet -f mono9 "Tunggu"
git clone https://github.com/MrBarBar05/ohmyzsh
cd ohmyzsh
bash install.sh
;;
0)
